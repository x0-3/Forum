...
CREATE TABLE IF NOT EXISTS `like` (
  ...
  CONSTRAINT `FK_like_topic` FOREIGN KEY (`topic_id`) REFERENCES `topic` (`id_topic`) ON DELETE CASCADE,
  CONSTRAINT `FK_like_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table forum.like: ~4 rows (approximately)
...
-- Dumping data for table forum.message: ~11 rows (approximately)
INSERT INTO `message` (`id_message`, `text`, `messCreatedAt`, `user_id`, `topic_id`) VALUES
	...
	(29, 'qsdfghj', '2023-04-03 14:39:09', 23, 2),
	(30, 'sdfghj\r\n', '2023-04-03 14:41:19', 23, 2),
	(33, 'qsdfghjklm', '2023-04-03 15:38:27', 24, 27),
	(35, 'test token', '2023-04-03 18:59:21', 23, 31),
	(36, 'testtest', '2023-04-03 19:10:45', 23, 31),
	(37, 'test', '2023-04-03 19:13:50', 23, 33),
	(38, 'dxfcgbhnj,', '2023-04-03 19:29:04', 23, 33),
	(39, 'xdfgh', '2023-04-03 19:29:32', 23, 33);
...
CREATE TABLE IF NOT EXISTS `topic` (
  ...
  CONSTRAINT `FK__category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id_category`) ON DELETE CASCADE,
  CONSTRAINT `FK_topic_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=latin1;

-- Dumping data for table forum.topic: ~5 rows (approximately)
INSERT INTO `topic` (`id_topic`, `title`, `topicCreatedAt`, `lockTopic`, `category_id`, `user_id`) VALUES
	...
	(27, 'test', '2023-04-03 15:28:11', 0, 2, 23),
	(31, 'qswdxfgyuioljkhjg', '2023-04-03 15:41:36', 1, 3, 21),
	(33, 'test topic token', '2023-04-03 19:13:39', 1, 4, 23);
