...
-- Dumping data for table forum.message: ~3 rows (approximately)
INSERT INTO `message` (`id_message`, `text`, `messCreatedAt`, `user_id`, `topic_id`) VALUES
	...
	(3, 'test', '2023-03-24 11:13:12', 1, 3);
...
-- Dumping data for table forum.topic: ~3 rows (approximately)
INSERT INTO `topic` (`id_topic`, `title`, `topicCreatedAt`, `lockTopic`, `category_id`, `user_id`) VALUES
	(1, 'What (Soul/R&B) Are You Listening To Right Now?', '2023-03-21 19:02:24', 0, 3, 1),
	(2, 'Sunday R&B Recommendation Thread - get/give recommendations here!', '2023-02-21 19:05:28', 0, 4, 2),
	(3, 'test', '2023-03-24 11:39:44', 0, 4, 1);
