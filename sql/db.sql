...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `messCreatedAt` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `topic` (
  ...
  `topicCreatedAt` datetime NOT NULL,
  `lockTopic` tinyint DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `pseudo` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `avatar` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `email` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `password` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `signUpData` datetime NOT NULL,
  `role` json DEFAULT NULL,
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Dumping data for table forum.user: ~0 rows (approximately)
INSERT INTO `user` (`id_user`, `pseudo`, `avatar`, `email`, `password`, `signUpData`, `role`) VALUES
